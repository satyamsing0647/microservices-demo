...
public class OrderController {
	...
	public ResponseEntity<Order> createOrderFallBack(Order myOrder, Throwable t){
		System.err.println("Fallback executed due to: " + t.getMessage());
		return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(null); //customize the response as needed
	}
